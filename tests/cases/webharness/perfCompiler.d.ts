...
declare var libString: string;
declare var compilerString: string;
declare class StringTextWriter implements ITextWriter {
    public buff: string;
    public Write(s: string): void;
    public WriteLine(s: string): void;
    public Close(): void;
